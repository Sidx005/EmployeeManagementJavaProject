...
public class AddEmployee extends JFrame implements ActionListener {
 ...
 int number=ran.nextInt(999999);
  ...
  AddEmployee(){
      ...
      tfname.setBounds(200,200,150,50);
      ...
      add(dob);
        ...
        address.setBounds(50,300,150,30);
        address.setFont(new Font("SAN_SERIF", Font.BOLD,20));
        add(address);

        taddress= new JTextField();
        taddress.setBounds(200,300,150,30);
        ...
        tphone.setBounds(500,250,150,30);
        ...
        email.setBounds(400,400,150,30);
        email.setFont(new Font("SAN_SERIF", Font.BOLD,20));
        add(email);

        temail= new JTextField();
        temail.setBounds(600,400,150,30);
        ...
        String items[]={"BBA","MBA","BCA","BA","MA","B.com","MCA","B.Tech","M.Tech","PhD","Other"};
